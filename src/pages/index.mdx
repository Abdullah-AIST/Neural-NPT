...
<Header
  ...
  links={[
    ...
    {
      name: "Code",
      url: "https://github.com/Abdullah-AIST/Neural-NPT",
      icon: "ri:github-line",
    },
    {
      name: "arXiv",
...
<ThreeColumns>
  <Video slot="left" source={video_woodBlock} />
  <Video slot="center" source={video_chips} />
  <Video slot="right" source={video_crackerBox} />
</ThreeColumns>

<ThreeColumns>
  <Video slot="left" source={video_bleachCleanser} />
  <Video slot="center" source={video_bleachCleanser} />
  <Video slot="right" source={video_tallBox} />
</ThreeColumns>

<ThreeColumns>
  <Video slot="left" source={video_powerDrill} />
  <Video slot="center" source={video_bowl} />
  <Video slot="right" source={video_pitcher} />
</ThreeColumns>

<ThreeColumns>
  <Video slot="left" source={video_woodblock2} />
  <Video slot="center" source={video_multi2} />
  <Video slot="right" source={video_sysID} />
</ThreeColumns>
