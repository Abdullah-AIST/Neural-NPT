...
It renames all the occurrences of BalanceReach (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the BalanceReach folder
        os.rename(
            os.path.join(root_dir_path, "exts", "BalanceReach", "BalanceReach"),
            os.path.join(root_dir_path, "exts", "BalanceReach", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "BalanceReach"), os.path.join(root_dir_path, "exts", new_name))
